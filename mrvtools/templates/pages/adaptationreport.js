...
console.log("hi");
frappe.require('frappe/node_modules/frappe-datatable/dist/frappe-datatable').then((DataTable) => {
	...
	frappe.views.QueryReport = class QueryReport extends frappe.views.BaseList {
		...
		load_report(route_options) {
			...
			this.route = "Adaptation Tracking Report";
			this.page_name = frappe.get_route_str();
			this.report_name = this.route;
